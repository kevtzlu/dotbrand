...
export async function POST(req: Request) {
    ...
    try {
        ...
        if (shouldLoadRenovationMatrix(combinedTextForDetection)) {
            const renovationMatrixPath = "/Users/kevin/Downloads/dotbrand-estimait-5/Data/RENOVATION_COST_FACTOR_MATRIX_v1.1.yaml";
        ...
        if (shouldLoadPriceList(combinedTextForDetection)) {
            const priceListPath = "/Users/kevin/Downloads/dotbrand-estimait-5/References/ESTIMAIT_California_Real_Price_List_v1.0.md.docx";
