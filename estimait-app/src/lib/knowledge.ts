...
export function detectBuildingType(text: string): string | null {
    ...
    // Civil/Infrastructure — must come before Healthcare
    if (t.includes("bridge") || t.includes("highway") || t.includes("roadway") ||
        t.includes("pavement") || t.includes("asphalt") || t.includes("paving") ||
        t.includes("culvert") || t.includes("caltrans") || t.includes("fhwa") ||
        t.includes("right-of-way") || t.includes("infrastructure")) return "CIVIL";
