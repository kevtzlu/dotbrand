...
2.  **執行強制性「二元分支」判斷 (Public vs. Private)**
    *   **掃描 BOD 關鍵字**: 檢查是否包含 "County of...", "Federal Project Number", "Prevailing Wage", "DBE Goal", "Public Works"。
    *   **路徑分流**:
...
| 2.2 | 2026-02-20 | 保持私人工程邏輯不變；新增公共工程分流、多點動員、量體定價與利潤反比邏輯 | PRODUCTION |
